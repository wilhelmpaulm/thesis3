...
<div  id="list_plug" class="list-group" >
    ...
    <div style="height: 60vh; overflow-y:auto; overflow-x: hidden">
        ...
        <ul class="list list-unstyled sidebar-menu">
            @foreach($cases as $c) 
            <?php $case_type_tags = Complaint_type_tag::where("complaint_id", "=", $c->id)->get(); ?>
...
<!--                        <div class="col-lg-1">
                        ...
                        <div class="col-lg-12">
                            <?php $suspects = DB::select("select * from complaint_subjects join clients on "
                                            . "complaint_subjects.client_id = clients.id where complaint_subjects.complaint_id = ?", [$c->id]);
                            ?>
                            <p class="list_name list_heading">
