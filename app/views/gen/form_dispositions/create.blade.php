...
?>
<form id="form1" action="{{URL::to("form_dispositions/store")}}" method="post">
    <div class="row ">
        ...
        <div class="col-lg-6">
            ...
            <div class="panel panel-black">
                ...
                <form id="form2" action="{{URL::to("agent/validate")}}" method="post">
                    <div class="panel-body">
        ...
        <div class="col-lg-6">
            <div class="panel panel-black">
                <div class="panel-heading">
                    <h3 class="panel-title">Disposition Report Form</h3>
                </div>
