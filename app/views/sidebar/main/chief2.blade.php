        ...
        <ul class="sidebar-menu f-osb">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li> <a href="{{URL::to("chief/cases-assign")}}" style=""><i class="fa fa-angle-double-right"></i> Assign Case</a></li>
                    ...
                    <li><a href="{{URL::to("chief/agent-case-timeline")}}"  style=""><i class="fa fa-angle-double-right"></i> Case Timeline</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
            ...
            <li class="treeview ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li> <a href="{{URL::to("chief/reports-demographics")}}" class="" style=""><i class="fa fa-angle-double-right"></i> Victim Demographics</a></li>
                    <li><a href="{{URL::to("chief/reports-demographics-subjects")}}" class="" style=""><i class="fa fa-angle-double-right"></i> Subject Demographics</a></li>
