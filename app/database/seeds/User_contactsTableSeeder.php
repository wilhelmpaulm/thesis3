...
class User_contactsTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        $user_contacts = array(
            ...
            //SECRETARY
            ["user_id" => 10930218, "type" => "Email", "contact" => "corayumol@nbi.com"],
            ...
            ["user_id" => 10930219, "type" => "Email", "contact" => "christopherpatrimonio@nbi.com"],
            ["user_id" => 10930220, "type" => "Email", "contact" => "gabelee@nbi.com"],
            ["user_id" => 10930221, "type" => "Email", "contact" => "albertfuego@nbi.com"],
            ["user_id" => 10930444, "type" => "Email", "contact" => "maximorivera@nbi.com"],
            ["user_id" => 10930445, "type" => "Email", "contact" => "jeffreysantos@nbi.com"],
            ["user_id" => 10930446, "type" => "Email", "contact" => "jamesmanahan@nbi.com"],
            ["user_id" => 10930447, "type" => "Email", "contact" => "aldrinsy@nbi.com"],
            ["user_id" => 10930448, "type" => "Email", "contact" => "chesterritualo@nbi.com"],
            ...
            ["user_id" => 10930444, "type" => "Mobile", "contact" => "09279450037"],
            ["user_id" => 10930445, "type" => "Mobile", "contact" => "09278554627"],
            ["user_id" => 10930446, "type" => "Mobile", "contact" => "09065574312"],
            ["user_id" => 10930447, "type" => "Mobile", "contact" => "09178908876"],
            ["user_id" => 10930448, "type" => "Mobile", "contact" => "09276579645"],
